...
export function SocialMediaCarousel({ format }: SocialMediaCarouselProps) {
              ...
              <div className="flex-1 flex items-start">
                <h1
                  ...
                  style={{
                    ...
                    fontFamily: 'Georgia, serif', // Plantin alternative
                  }}
                >
                ...
                <div className="flex justify-center">
                  <div
                    ...
                    style={{
                      ...
                      color: currentSlideData.textColor === 'white' ? 'white' : 'black',
                    }}
                  >
                    ABRAKADABRA
                  </div>
                ...
                {currentSlideData.showLogo && (
                  <div className="flex justify-center">
                    <img 
                      ...
                      style={{
                        filter: currentSlideData.textColor === 'white' ? 'invert(1) brightness(2)' : 'none'
                      }}
                    />
                  </div>
                )}
